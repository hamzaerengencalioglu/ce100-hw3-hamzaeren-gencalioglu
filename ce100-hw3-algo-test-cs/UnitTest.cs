...
public class UnitTest {
  ...
  public void HuffmanCoding_Txt_Test() {
    ...
    string inputFilePath = "Mp3-Txt_Folder/Txt_Input.txt";
    string compressedFilePath = "Mp3-Txt_Folder/Txt_Compressed.bin";
    string decompressedFilePath = "Mp3-Txt_Folder/Txt_Output.txt";
  ...
  public void HuffmanCoding_Mp3_Test() {
    string inputFilePath = "Mp3-Txt_Folder/GoodTime_Input.mp3";
    string compressedFilePath = "Mp3-Txt_Folder/GoodTime_Compressed.bin";
    string decompressedFilePath = "Mp3-Txt_Folder/GoodTime_Output.mp3";
